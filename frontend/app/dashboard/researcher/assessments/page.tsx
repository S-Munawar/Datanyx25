...
export default function ResearcherAssessments() {
  ...
  const fetchAssessments = async () => {
    try {
      setLoading(true);
      const response = await researcherApi.getAssessments({
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Research Assessments</h1>
          <p className="text-gray-600 mt-1">Manage research health assessments and analysis</p>
        </div>
        <Link
          href="/assessment"
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-lg shadow p-8 text-center">
          ...
          <p className="text-gray-500 mb-4">Create your first assessment for research</p>
          <Link
            href="/dashboard/researcher/assessments/new"
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {assessments.map((assessment) => (
                  <tr key={assessment.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className="text-sm text-gray-900">
                        {assessment.prediction?.confidence ? `${assessment.prediction.confidence.toFixed(1)}%` : '-'}
                      </span>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right">
                      <Link
                        href={`/dashboard/researcher/assessments/${assessment.id}`}
